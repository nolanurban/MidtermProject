...
START TRANSACTION;
USE `clubindexdb`;
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `location_id`, `profile_url`, `about_me`) VALUES (1, 'ash', 'ozz', 'ashozz', 'ashley@abc.com', 'abc', NULL, 'owner and member', 1, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `location_id`, `profile_url`, `about_me`) VALUES (2, 'tyler', 'tanner', 'dopeyboy', 'tylert123@abc.com', 'abc', NULL, 'owner and member', 2, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `location_id`, `profile_url`, `about_me`) VALUES (3, 'Nolan', 'Urban', 'dadjokes', 'dadjokes@abc.com', 'abc', NULL, 'owner and member', 3, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `location_id`, `profile_url`, `about_me`) VALUES (4, 'userA', 'userA', 'userA', 'userA@abc.com', 'abc', NULL, 'member ', 4, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `location_id`, `profile_url`, `about_me`) VALUES (5, 'userB', 'userB', 'userB', 'userB@abc.com', 'abc', NULL, 'member ', 5, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `location_id`, `profile_url`, `about_me`) VALUES (6, 'userC', 'userC', 'userC', 'userC@abc.com', 'abc', NULL, 'member ', 6, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `location_id`, `profile_url`, `about_me`) VALUES (7, 'userD', 'userD', 'userD', 'userD@abc.com', 'abc', NULL, 'member ', 7, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `location_id`, `profile_url`, `about_me`) VALUES (8, 'userE', 'userE', 'userE', 'userE@abc.com', 'abc', NULL, 'member ', 8, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `location_id`, `profile_url`, `about_me`) VALUES (9, 'userF', 'userF', 'userF', 'userF@abc.com', 'abc', NULL, 'member ', 9, NULL, NULL);
...
INSERT INTO `book_club` (`id`, `max_members`, `create_date`, `digital`, `owner_id`, `location_id`, `profile_url`, `about_club`, `name`) VALUES (2, 5, '2022-10-21 17:34:10', 1, 2, 2, NULL, 'Fantasy', 'Gamerz$Lyfe');
INSERT INTO `book_club` (`id`, `max_members`, `create_date`, `digital`, `owner_id`, `location_id`, `profile_url`, `about_club`, `name`) VALUES (3, 10, '2022-10-22 17:34:10', 1, 3, 3, NULL, 'Historical', 'BestTeach');
